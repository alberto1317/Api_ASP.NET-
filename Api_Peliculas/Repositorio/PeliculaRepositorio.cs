...
namespace Api_Peliculas.Repositorio
{
    public class PeliculaRepositorio : IPeliculaRepositorio
    {
        ...
        {
            Boolean valor = _bd.Pelicula.Any(c => c.Nombre.ToLower().Trim() == nombre.ToLower().Trim());
            return valor;
        }
        ...
        {
            return _bd.Pelicula.Include(ca => ca.Categoria).Where(ca => ca.categoriaId == ca.catId).ToList();
        }
